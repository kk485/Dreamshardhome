      ...
      <div v-else class="lrc" @dblclick="toggleForceIcon">
        ...
        <Transition name="fade" mode="out-in" :id="`lrc-line-${store.playerLrc[0][2]}`"
          ...
          <div class="lrc-all"
            ...
            <!-- 修改点 1：左侧第一个音符 -->
            <Icon icon="icon-park-outline:music-one" width="18" style="color: var(--footer-music-icon-color);" />
            &nbsp;
            <!-- 修改点 2：左侧猫爪 -->
            <Icon icon="mdi:paw" width="20" class="paws-1" style="transform: rotate(-18deg); color: var(--footer-music-paw-icon-color);" />
            ...
            <!-- 修改点 3：右侧猫爪 -->
            <Icon icon="mdi:paw" width="20" class="paws-2" style="transform: rotate(18deg); color: var(--footer-music-paw-icon-color);" />
            &nbsp;
            <!-- 修改点 4：右侧第二个音符 -->
            <Icon icon="icon-park-outline:music-one" width="18" style="color: var(--footer-music-icon-color);" />
          </div>
        ...
        <Transition name="fade" mode="out-in" v-else>
          ...
          <div class="lrc-all" :key="store.getPlayerLrc.length > 0 ?
            ...
            &nbsp;
            <!-- 修改点 6：左侧猫爪 -->
            <Icon icon="mdi:paw" width="20" class="paws-3" style="transform: rotate(-18deg); color: var(--footer-music-paw-icon-color);" />
            
            <span class="lrc-text text-truncate-ellipsis" v-html="store.getPlayerLrc[0][4]" :class="`lrc-char`" />
            
            <!-- 修改点 7：右侧猫爪 -->
            <Icon icon="mdi:paw" width="20" class="paws-4" style="transform: rotate(18deg); color: var(--footer-music-paw-icon-color);" />
            &nbsp;
            <!-- 修改点 8：右侧第二个音符 -->
            <Icon icon="icon-park-outline:music-one" width="18" style="color: var(--footer-music-icon-color);" />
          </div>
